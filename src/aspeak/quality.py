...
QUALITIES = {
    ...
    'mp3': {
        -3: SpeechSynthesisOutputFormat.Audio16Khz32KBitRateMonoMp3,
        -2: SpeechSynthesisOutputFormat.Audio16Khz64KBitRateMonoMp3,
        -1: SpeechSynthesisOutputFormat.Audio16Khz128KBitRateMonoMp3,
        0: SpeechSynthesisOutputFormat.Audio24Khz48KBitRateMonoMp3,
        1: SpeechSynthesisOutputFormat.Audio24Khz96KBitRateMonoMp3,
        2: SpeechSynthesisOutputFormat.Audio24Khz160KBitRateMonoMp3,
        3: SpeechSynthesisOutputFormat.Audio48Khz96KBitRateMonoMp3,
        4: SpeechSynthesisOutputFormat.Audio48Khz192KBitRateMonoMp3,
    },
    'ogg': {
